...
class PlacementGroups(private val httpClient: HttpClient) {
    ...
    @Throws(Error::class)
    suspend fun find(id: Id): Item<PlacementGroup> = httpClient.makeRequest(Route.GET_A_PLACEMENT_GROUP, id)
    ...
    suspend fun update(id: Id, body: UpdatePlacementGroup): Item<PlacementGroup> = httpClient.makeRequest(Route.UPDATE_PLACEMENT_GROUP, resourceId = id, body = body)
